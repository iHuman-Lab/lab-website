...
resources:
  - screenshots/Media.mov
format:
  revealjs:
    include-in-header: ../_assets/people-row.html
...
:::
::: {.column width="65%"}
<video data-autoplay loop muted playsinline src="screenshots/Media.mov" style="width:100%; border-radius:6px; box-shadow:0 4px 20px rgba(0,0,0,0.4);"></video>
:::
:::
